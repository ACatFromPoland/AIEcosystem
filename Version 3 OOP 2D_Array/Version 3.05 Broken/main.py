...
class Animal():
    ...
    def WalkTo(self, WalkToPos=None, randomBool=False, randomInt=0):
        global MapArray2D
        if WalkToPos != None:
            Fx = WalkToPos[0]
            Fy = WalkToPos[1]
        ...
        # UPS
        if Fy > Oy and Fx < Ox or randomBool == True and randomInt == 0:
            # up left
            MapArray2D[Ox][Oy] = 0
            MapArray2D[Ox - 1][Oy + 1] = 2
            self.xPos -= 1
        ...
        elif Fy > Oy and Fx == Ox or randomBool == True and randomInt == 1:
            # up
            MapArray2D[Ox][Oy] = 0
            MapArray2D[Ox][Oy + 1] = 2
            self.yPos += 1
        ...
        elif Fy > Oy and Fx < Ox or randomBool == True and randomInt == 2:
            # up right
            MapArray2D[Ox][Oy] = 0
            MapArray2D[Ox + 1][Oy + 1] = 2
            self.xPos += 1
        ...
        # MIDDLES
        elif Fy == Oy and Fx < Ox or randomBool == True and randomInt == 3:
            # left
            MapArray2D[Ox][Oy] = 0
            MapArray2D[Ox - 1][Oy]  = 2
            self.xPos -= 1
        ...
        elif Fy == Oy and Fx > Ox or randomBool == True and randomInt == 4:
            #right
            MapArray2D[Ox][Oy] = 0
            MapArray2D[Ox + 1][Oy] = 2
            self.xPos += 1
        ...
        # DOWNS
        elif Fy < Oy and Fx < Ox or randomBool == True and randomInt == 5:
            #down left
            MapArray2D[Ox][Oy] = 0
            MapArray2D[Ox - 1][Oy - 1] = 2
            self.xPos -= 1
        ...
        elif Fy < Oy and Fx == Ox or randomBool == True and randomInt == 6:
            #down
            MapArray2D[Ox][Oy] = 0
            MapArray2D[Ox][Oy - 1] = 2
            self.yPos -= 1
        ...
        elif Fy < Oy and Fx > Ox or randomBool == True and randomInt == 7:
            #down right
            MapArray2D[Ox][Oy] = 0
            MapArray2D[Ox + 1][Oy - 1] = 2
            self.xPos += 1
    ...
    def MoveRandomly(self):
        ...
        Animal.WalkTo(self, None,True, randomint)
